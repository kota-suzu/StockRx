  ...
  describe 'validations' do
    describe 'page' do
      it 'validates numericality greater than 0' do
        ...
        expect(form.errors[:page]).to include(I18n.t('errors.messages.greater_than', count: 0))
      end
    ...
    describe 'per_page' do
      it 'validates inclusion in [10, 20, 50, 100]' do
        form.per_page = 15
        expect(form).not_to be_valid
        expect(form.errors[:per_page]).to include(I18n.t('errors.messages.inclusion'))
      end
    ...
    describe 'sort_direction' do
      it 'validates inclusion in [asc, desc]' do
        ...
        expect(form).not_to be_valid
        expect(form.errors[:sort_direction]).to include(I18n.t('errors.messages.inclusion'))
      end
