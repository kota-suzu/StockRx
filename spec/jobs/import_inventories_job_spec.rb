...
RSpec.describe ImportInventoriesJob, type: :job do
  ...
  describe '#perform' do
    ...
    context 'cjCSVÕ¡¤ën4' do
      ...
      it 'skip_invalidLtruen4o	¹jì³üÉn¤óÝüÈY‹Sh' do
    ...
    context ''ÏÇü¿n¤óÝüÈ' do
      before do
        csv_file.write(large_csv_content)
        csv_file.rewind
      end

      it 'ÐÃÁæg¤óÝüÈY‹Sh' do
        expect {
